...
/**
 * @file
 * Definition of Drupal\movie_views\Plugin\views\join\MovieBudgetJoin
 */
 ...
 *
 * @ViewsJoin("movie_budget_join")
 */
class MovieBudgetJoin extends JoinPluginBase implements JoinPluginInterface {
  ...
  public static function create(array $configuration, $plugin_id, $plugin_definition) {
    ...
    $plugin_id = empty($plugin_id) ? 'movie_budget_join' : $plugin_id;
  ...
  public function buildJoin($select_query, $table, $view_query) {
    $select_query->addJoin(
      ...
      'node__field_budget',
      'budget',
      'node_field_data.nid=budget.entity_id'
    );
  }
